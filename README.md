...
3. **[chinese_chengyujielong](https://github.com/taishan1994/chinese_chengyujielong)** - 成语接龙数据集
   - 爬取自 https://cy.hwxnet.com/
   - 补充了 12,457 条成语，是目前最大的成语数据源之一
   - 包含大量稀有和生僻成语
   
4. **手动补充** - 常见但缺失的成语词语
   - 如：扬名立万、走街串巷等

通过合并去重，相比原始数据集增加了 **13,163 条成语**，覆盖更全面。
